...
# _T_cam_velo = np.array([-0.3, -0.0583,  -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([-0.2, -0.0583,  -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([-0.1, -0.0583,  -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([0.0, -0.0583, -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([0.1, -0.0583, -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([0.2, -0.0583, -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([0.3, -0.0583, -0.015, 1.57, -1.35, 0.0])

# _T_cam_velo = np.array([0.0, -0.3, -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([0.0, -0.2, -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([0.0, -0.1, -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([0.0, 0.0, -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([0.0, 0.1, -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([0.0, 0.2, -0.015, 1.57, -1.35, 0.0])
# _T_cam_velo = np.array([0.0, 0.3, -0.015, 1.57, -1.35, 0.0])

# _T_cam_velo = np.array([0.0, -0.0583, -0.3, 1.6, -1.36, -0.035])
# _T_cam_velo = np.array([0.0, -0.0583, -0.2, 1.6, -1.36, -0.035])
# _T_cam_velo = np.array([0.0, -0.0583, -0.1, 1.6, -1.36, -0.035])
# _T_cam_velo = np.array([0.0, -0.0583, 0.0, 1.6, -1.36, -0.035])
# _T_cam_velo = np.array([0.0, -0.0583, 0.1, 1.6, -1.36, -0.035])
# _T_cam_velo = np.array([0.0, -0.0583, 0.2, 1.6, -1.36, -0.035])
# _T_cam_velo = np.array([0.0, -0.0583, 0.3, 1.6, -1.36, -0.035])
_T_cam_velo = np.array([-0.0208333, -0.104167, 0.104167, 1.59917, -1.32083, -0.0291667])
